...
num_single_stim_type = int(num_epochs_in_cluster/3) # divide in 3 because we have left and right movement, and translation
...
for stim in epoch_cluster_list:
    ...
    translation.append(stim['Translation'])
